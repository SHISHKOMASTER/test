package net.shishkomaster.whm.common.item.weapon;
...
import net.shishkomaster.whm.client.renderer.weapons.BolterRenderer;
...
public class BolterItem extends Item implements IAnimatable, ISyncable {
    public AnimationFactory factory = new AnimationFactory(this);
    public String controllerName = "controller";
    public static final int ANIM_OPEN = 0;

    public BolterItem() {
        super(new Item.Properties().tab(ModItemGroups.WHM_TAB).stacksTo(1).durability(201)
                .setISTER(() -> BolterRenderer::new));
